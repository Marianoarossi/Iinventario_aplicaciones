...
class VistaInventario:
    def __init__(self, window):
        ...
        titulo = Label(self.root, text="Ingrese los datos de la Aplicación", bg="#76B6E3", fg="White", height=1, width=80)
        ...
        boton_modificar = Button(self.root, text="Modificar", command=lambda: self.abmc.modificar(tree, boton_alta,id_val, nombre_val, tipo_val, nivel_val, ruta_val, descripcion_val))
        boton_limpiar = Button(self.root, text="Limpiar campos", command=lambda: self.abmc.limpiar(tree, boton_alta,id_val, nombre_val, tipo_val, nivel_val, ruta_val, descripcion_val))
        boton_salir = Button(self.root, text="Salir", command=root.quit)
